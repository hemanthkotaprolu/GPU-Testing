...
train_tokenized_dataset = dataset["train"].map(tokenize_function, batched=True, batch_size=2)
...
val_tokenized_dataset = dataset["validation"].map(tokenize_function, batched=True, batch_size=2)
